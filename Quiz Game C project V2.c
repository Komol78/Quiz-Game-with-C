...
int main() ///Main code
{
    ...
    char choice;
    char playername[20];
    time_t now; /// Present time and date mention here
    time(&now);
    printf("\n");
    printf("\t\t\t\t\t\t\t\t\t\t\t %s\n",ctime(&now));

mainhome: ///take a input for start game main home

    printf("\n\t\t WELCOME TO Quiz Game (I.Q. test) PROGRAM\n\n");
    printf("\n\t\t-------------------------------");
    ...
    else if(choice=='S')
    {
        ...
        system("cls");
        printf("\n .......... Welcome %s to C Program Quiz Game(I.Q test) ..........",playername);
...
home:
        ...
        for(i=1; i<=3; i++)
        {
            ...
            case 2:
                printf("\n\nWhat is chemical symbol for the element of Oxygen?");
                printf("\n\nA.O\tB.C\n\nC.S\tD.Cl\n\n");
                if (toupper(getch())=='A')
                {
                    printf("\n\nCorrect!!!");
                ...
                {
                    printf("\n\nWrong!!! The correct answer is A.O");
                    getch();
                    system("cls");
                    break;
                }
            ...
            case 3:
                ...
                {
                    printf("\n\nWrong!!! The correct answer is C.Nitrogen");
                    getch();
                    system("cls");
                    break;
                }
...

        {
            ...
            getch();
            goto mainhome; ///  Inf not Eleigible for game
        }

test: ///1st Round test game if win
        system("cls");
...
game: /// Start game input from user
        counter=0;
        for(i=1; i<=10; i++)
        {
            system("cls");
            ...
            case 5:
                printf("\n\n\nPure water has pH level of a arround?");
                printf("\n\nA.7\tB.5\n\nC.3\tD.4\n\n");
                if(toupper(getch())=='A')
                {
                    printf("\n\nCorrect!!!");
...
void show_record() ///Show Player Record
{
    ...
    printf("\n\n\t\t.............................................................");
    printf("\n\n\t\t %s The Highest Score %f",name,scr);
    printf("\n\n\t\t.............................................................");
    fclose(f);
    getch();
}
...
void help() ///For Help Details
{
    system("cls");
    printf("\n\n                              HELP");
    printf("\n -------------------------------------------------------------------------");
    printf("\n ......................... C program Quiz Game (I..Q test)...........");
    printf("\n >> There are two rounds in the game");
    printf("\n >> In 1st round you will be asked a total of 3 questions to test your general");
    printf("\n    knowledge. You will be eligible to play the game if you can give atleast 2");
    printf("\n    right answers otherwise you can't play the Game...........");
    printf("\n >> Your game starts with the 2nd. In this round you will be asked");
